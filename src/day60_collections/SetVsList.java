...
//        System.out.println("first: "+list2.get(0));      Set does not allow duplicates
//        System.out.println("last: "+list2.get(list2.size()-1));
        ...
        System.out.println(new HashSet<>(Arrays.asList(1,5,1,4,2,5,1))); // asList method return List type, which can have the reference of the Collection interface, so we are able to make an object of HashSet with these initial values

        String s = "aaaaaaaaaabbbbbbbbcccccccddddddeeee";
