...
public class ComputerLab {
    ...
    public static void main(String[] args) {
        ...
        ComputerHW comp = new ComputerHW("HP", "Silver", 500);

        System.out.println(ComputerHW.hasBattery);

        ComputerHW.hasBattery = false;  // valid entry, reasining*

        //System.out.println(Computer.brand); invalid entry. this is instance variable
        System.out.println(comp.brand); // valid entry
